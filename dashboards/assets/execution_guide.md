...
│  data_generator_v7.py → raw CSVs in data_sources/generators/raw/        │
...
│   ├── collections_project/
│   │   ├── collections_dashboard.pbix   # Main deliverable
│   │   └── collections_dashboard_v2.pbix # Legacy (reference only)
│   ├── assets/
...
# 4. Open Power BI
# Open dashboards/collections_project/collections_dashboard.pbix
\`\`\`
