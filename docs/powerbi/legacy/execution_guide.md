...
> **ARCHIVED (2026-08-31).** Moved under `docs/powerbi/legacy/`. The current, current-state Power BI docs are
> `docs/powerbi/dashboard_blueprint.md` (9-page wireframes), `docs/powerbi/dax_measures_all.md` (148-measure
> reference, auto-generated), and `docs/powerbi/PHASE9_EXECUTION_PLAN.md` (actionable Phase 9 plan).

> ⚠️ **HISTORICAL SNAPSHOT (v1.0, pre-P3/P4).** Table/measure counts below reflect an earlier schema era (e.g., "11 tables", "70+ measures"). Current truth: **16 tables (8 dim + 7 fact + etl_load_log), 148 active DAX measures (5 tables) + 18-item `_Time Intelligence` calculation group** — see `AGENTS.md`, `docs/CHANGELOG.md` 1.6.0 and `docs/powerbi/dashboard_blueprint.md` for the build. Architecture patterns and DAX techniques remain valid; numbers do not.
