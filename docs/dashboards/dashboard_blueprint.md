...
**DAX source of truth:** `docs/dashboards/dax_measures_all.md` (256 measures, 13 tables)
...
1. Open `dax_measures_all.md` — it contains all 256 DAX measures as copy-paste code blocks
2. For each measure:
...
> **End of Blueprint.**
> For DAX formulas, refer to `docs/dashboards/dax_measures_all.md` (256 measures).
