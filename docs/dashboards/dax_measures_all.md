...
## _Time Intelligence — Calculation Group (18 items)

*Replaces all per-metric TI measures. Apply `_Time Intelligence[Calculation Item]` as a slicer/filter to any base measure. Predecessor: the 118 legacy TI measures live in `dashboards/dax/legacy/time_intelligence_legacy.csv` (retired v3.2).*
